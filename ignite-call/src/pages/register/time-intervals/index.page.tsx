...
const timeIntervalsFormSchema = z.object({
    intervals: z
        ...
        .refine(intervals => {
            ...
            message: 'O horário de término deve ser de pelo menos 1h distante do início'
        })
})
    ...
    return (
        <Container>
            <Header>
                ...
                <Text>
                    Defina o intervalo dos horários que você esta disponível em cada dia da semana.
                </Text>
